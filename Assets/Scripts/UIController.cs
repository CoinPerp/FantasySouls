...
public class UIController : MonoBehaviour
{
    ...
    public void RecoverAfterAttack(bool charge, float amount)
    {
        ...
        if(!charge)
        {
            recoverAmount = damageAble.GetRecentDamageAmount() * 0.3f;
        ...
        else
        {
            ...
            {
                recoverAmount = damageAble.GetRecentDamageAmount();
                Debug.Log("Time hold"+attackchain.hold);
        ...
        damageAble.reduceRecentAmountDmg(recoverAmount);
        UpdaterecoverableHealthslider()
;
    }
    ...
    private void UpdaterecoverableHealthslider()
    {
        ...
        {
            recoverableHealthslider.value = damageAble.health + damageAble.GetRecentDamageAmount();
        }
